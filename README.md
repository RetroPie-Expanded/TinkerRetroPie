...
When [https://github.com/EriHoss/TinkerRetroPie/blob/master/tools/installer.cfg](installer.cfg) is present in the installer
directory, it will be used to define all install options. This will be the case when you use the [https://github.com/EriHoss/TinkerRetroPie/blob/master/tools/build_release.sh](build_release.sh) or [https://github.com/EriHoss/TinkerRetroPie/blob/master/tools/build_dev_release.sh](build_dev_release.sh) scripts to build the Armbian image / RetroPie installer combo.
